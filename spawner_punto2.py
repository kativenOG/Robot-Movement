...
positions = [[-0.33,0.25],[-0.1,0.35],[0.1,0.25],[0.25,0.2],[0.35,0.45],[-0.33,0.5],[-0.1,0.55],[0.1,0.52],[0.25,0.6],[0.35,0.65],[0,0.7]] 

for i in range(0,11):
    # Posizione del blocco 
    pos = Pose(Point(-positions[i][0],-positions[i][1] ,0.775), Quaternion(0,0,random.uniform(-3.14, 3.14), random.uniform(-1.57, 1.57)))
