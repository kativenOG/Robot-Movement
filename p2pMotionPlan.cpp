...
void ur5::p2pMotionPlan(RowVectorXf &qEs, Vector3f &xEf, Vector3f &phiEf, float deltaT, MatrixXf &Th_1, MatrixXf &xE_1, MatrixXf &phiE_1){
...
int main(){
    ...
    MatrixXf xE;
    MatrixXf phiE;
    u.p2pMotionPlan(v1, v2, v3, 0.01, Th, xE, phiE);
    cout << "Th" << endl
         << Th << endl
         << endl;
    cout << "xE" << endl
